...
public class OffermanagementRestServiceImpl implements OffermanagementRestService {
  ...
  @Override
  public SpecialCto getSpecialCto(long id) {

    return this.offermanagement.findSpecialCto(id);
  }

  @Override
  public PaginatedListTo<SpecialCto> findSpecialCtosByPost(SpecialSearchCriteriaTo searchCriteriaTo) {

    return this.offermanagement.findSpecialCtos(searchCriteriaTo);
  }
